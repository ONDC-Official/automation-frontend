...
router.post("/", otelTracing('body.transaction_id', 'body.session_id', 'body.bap_id', 'body.bpp_id'), createSession);
...
router.put("/", otelTracing('body.transaction_id', 'body.session_id', 'body.bap_id', 'body.bpp_id'), updateSession);
