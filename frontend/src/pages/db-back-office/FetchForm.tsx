...
const FetchForm: FC<FetchFormProps> = ({ fetchParams, isLoading, onFetchParamsChange, onFetch }) => (
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div>
        ...
        <input
          ...
          onChange={e => onFetchParamsChange({ ...fetchParams, domain: e.target.value })}
      ...
      <div>
        ...
        <input
          ...
          onChange={e => onFetchParamsChange({ ...fetchParams, version: e.target.value })}
          className="bg-white w-full px-3 py-2 border border-sky-200 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
      ...
      <div>
        ...
        <select
          ...
          onChange={e => onFetchParamsChange({ ...fetchParams, action: e.target.value })}
          className="bg-white w-full px-3 py-2 border border-sky-200 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500">
