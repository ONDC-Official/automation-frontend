 ...
 */
export function generateConfigId(domain: string, version: string, flowId: string, isGist?: boolean): string {
 ...
 */
export function loadConfigByIdentifiers(domain: string, version: string, flowId: string): SavedConfig | null {
