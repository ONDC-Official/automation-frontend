    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
            <Textarea
                ...
                className="bg-white border-gray-300 rounded shadow-none px-3 py-2 text-sm font-mono resize-none focus:outline-hidden focus:ring-2 focus:ring-sky-500 disabled:bg-gray-50"
            />
