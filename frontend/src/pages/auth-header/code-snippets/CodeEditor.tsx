...
const CodeEditor: FC<CodeEditorProps> = ({ code, language, selectedLang, functionType, copied, onCopy }) => {
  ...
  return (
    <div className="relative bg-gray-900 rounded-xl overflow-hidden border border-gray-700">
      ...
      <Editor height={EDITOR_HEIGHT} language={language} value={code} theme="vs-dark" options={EDITOR_OPTIONS} />
    </div>
  );
};
