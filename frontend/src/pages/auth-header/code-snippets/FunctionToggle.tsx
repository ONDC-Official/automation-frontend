  ...
  <div className="flex gap-2">
    <button
      ...
      className={`px-4 py-2 rounded-lg font-medium transition-all ${
        functionType === "generate" ? "bg-green-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
      }`}
    ...
    <button
      ...
      className={`px-4 py-2 rounded-lg font-medium transition-all ${
        functionType === "verify" ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
      }`}
