...
const CodeSnippets: FC = () => {
  const { selectedLang, setSelectedLang, functionType, setFunctionType, languages, currentSnippet, currentCode } =
    useCodeSnippet();
  ...
  return (
    <div className="space-y-4">
      <LanguageSelector languages={languages} selectedLang={selectedLang} onLanguageChange={setSelectedLang} />
