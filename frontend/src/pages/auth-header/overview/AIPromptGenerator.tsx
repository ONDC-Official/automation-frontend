    ...
    <div className="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200 rounded-xl p-6">
      ...
      <div className="mt-4 bg-violet-100 border border-violet-300 rounded-lg p-3">
        <p className="text-sm text-violet-800">
          <strong>💡 Tip:</strong> Replace <code className="bg-violet-200 px-1 rounded">[YOUR_LANGUAGE/FRAMEWORK]</code>{" "}
          with your preferred tech stack (e.g., "Rust", "C#/.NET", "Ruby on Rails", "Kotlin", "Swift") before pasting to
          the AI.
        </p>
      </div>
    </div>
