...
import type { IValidationErrorsPanelProps } from "@/pages/schema-validation/types";
import { Button } from "@/components/shadcn/button";
import { ErrorItem } from "@/pages/schema-validation/ErrorItem";
import { ExclamationTriangleIcon } from "@heroicons/react/20/solid";

/**
 * Footer panel below the JSON editor showing validation success or errors.
 */
            ...
            >
                <div className="flex items-center gap-2 min-w-0">
                    <ExclamationTriangleIcon
                        className="h-5 w-5 text-error-500 shrink-0"
                        aria-hidden
                    />
