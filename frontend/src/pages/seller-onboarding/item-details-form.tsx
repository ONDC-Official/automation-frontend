...
const ItemDetailsForm: React.FC<ItemDetailsFormProps> = ({ initialData, onNext, onPrevious }) => {
  ...
  const handleCreateVariants = (itemIndex: number) => {
    ...
    const generateCombinations = (attrs: string[], index: number = 0): Record<string, string>[] => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Add your product/service items with detailed information</p>
      </div>
          ...
          <div key={field.id} className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Name"} required={true} />
                  ...
                  {watchItems[index]?.domain !== "F&B" && (
                    <div className="md:col-span-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="md:col-span-2">
                          <LabelWithToolTip labelInfo={""} label={"Code Value"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Short Description"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Long Description"} required={true} />
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Unit"} required={true} />
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        ...
                        >
                          ...
                          <Select.Option value="millilitre">Millilitre</Select.Option>
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Value"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Availability"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Maximum Count"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Minimum Count"} required={true} />
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Selling Price"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"MRP"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Currency"} required={true} />
              ...
              <div className="md:col-span-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Store"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Category"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Return Window"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Replacement Window"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Time to Ship"} required={true} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Returnable"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Cancellable"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"CoD Availability"} required={true} />
                    ...
                    <div className="mb-4">
                      ...
                      {referBackImage && (
                        <p className="text-sm text-blue-600 mt-1">
                          When referring to back image, statutory requirements are not needed.
                        </p>
                      )}
                    </div>
              ...
              <div className="md:col-span-2">
                <h4 className="font-medium text-gray-700 mb-3">Miscellaneous Details</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Country of Origin"} required={true} />
              ...
              <div className="md:col-span-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Email"} required={true} />
                  ...
                  <div>
                    <LabelWithToolTip labelInfo={""} label={"Contact No."} required={true} />
                ...
                if (
                  ...
                  return (
                    <div className="md:col-span-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          <LabelWithToolTip labelInfo={""} label={"Brand"} required={true} />
                          <Controller
          ...
          <div className="space-y-4">
            ...
            {selectedVariantAttributes[index] && selectedVariantAttributes[index].length > 0 && (
              <>
                ...
                {variantValues[index] && Object.keys(variantValues[index]).length > 0 && (
                  <div className="p-3 bg-blue-50 rounded">
                    ...
                    <p className="text-xs text-blue-600">Combinations based on your input values</p>
                  </div>
                )}
              </>
            )}
      ...
      >
        {editingVariant && (
          <Form form={variantForm} layout="vertical" className="max-h-[600px] overflow-y-auto">
            ...
            {/* Pricing Section */}
            <div className="mb-6">
              <h3 className="text-lg font-semibold mb-4 border-b pb-2">Pricing</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Form.Item
                  label="Selling Price (₹)"
                  name="selling_price"
            ...
            {/* Quantity Section */}
            <div className="mb-6">
              <h3 className="text-lg font-semibold mb-4 border-b pb-2">Quantity & Units</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Form.Item label="Maximum Count" name="maximum_count">
                  <Input type="number" placeholder="Enter maximum order quantity" />
                </Form.Item>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Object.entries(editingVariant.attributes)
                    .filter(([key]) => !editingVariant.variantCombination?.[key])
                    .filter(
                      ([key]) =>
                        ![
                          "name",
