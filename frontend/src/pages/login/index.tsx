...
const LoginPage: FC = () => (
  <div className="font-sans flex items-center justify-center min-h-screen p-4">
    <div className="bg-white shadow-xl rounded-2xl p-8 sm:p-10 max-w-md w-full text-center">
      ...
      {/* Heading */}
      <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-2">Welcome to Protocol Workbench</h1>

      {/* Subheading */}
      <p className="text-slate-500 mb-8">Connect your GitHub account to get started quickly</p>
