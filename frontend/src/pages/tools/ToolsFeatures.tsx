            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {toolFeatures.map((feature, index) => (
                        ...
                        >
                            <div className="absolute inset-0 bg-linear-to-r from-sky-50/0 to-sky-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            <div className="relative flex items-start space-x-5">
                                <div className="shrink-0 w-16 h-16 bg-linear-to-br from-sky-50 to-sky-100 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    {feature.icon}
                                </div>
