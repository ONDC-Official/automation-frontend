...
export default function FilterFlowsMenu({ flowTags, setSelectedTags, selectedTags }: FilterFlowMenuProps) {
  ...
  const toggleSelect = (item: string) => {
    setSelectedTags((prev: any) => (prev.includes(item) ? prev.filter((v: any) => v !== item) : [...prev, item]));
  };
