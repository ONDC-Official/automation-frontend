		...
		<div className={`h-full flex flex-col transition-all duration-300  `}>
            ...
            <h1 className="text-lg font-semibold text-gray-800">Beckn JSON</h1>
					...
					<div className="flex flex-col shadow-sm">
						<div className="flex flex-row items-center justify-between bg-white p-4 rounded-t-md border border-zinc-200 ">
                ...
                {mdData && (
                  <Watermak status={isSuccessReponse ? "success" : "failed"} />
							...
							<div className="h-96 p-3 border bg-white shadow-sm overflow-y-scroll">
								<div className="pr-4">
									<Markdown
										components={{
											a: ({ href, children }: any) => (
