...
const CommentComposer: FC<CommentComposerProps> = ({ value, onChange, onSubmit }) => (
    <div className="shrink-0 mb-4 p-4 rounded-2xl bg-white dark:bg-surface-elevated border border-slate-200/80 shadow-xs">
        <Textarea
            ...
            rows={2}
            className="w-full px-3 py-2.5 text-sm text-slate-800 placeholder-slate-400 bg-slate-50/80 dark:bg-surface-muted/80 rounded-xl border-0 shadow-none focus:ring-2 focus:ring-sky-500/20 focus:bg-white dark:focus:bg-surface-elevated resize-none transition-colors"
        />
