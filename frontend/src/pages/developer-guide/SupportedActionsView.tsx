        ...
        <div className="w-full flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-sky-50 border border-sky-100 shadow-xs shrink-0">
                        <svg
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                    {/* Cards / Graph toggle */}
                    <div className="flex rounded-xl border border-slate-200 overflow-hidden shadow-xs shrink-0 bg-white">
                        <button
                    ...
                    <div className="relative w-full sm:w-72">
                        ...
                        <input
                            ...
                            className="w-full rounded-xl border border-slate-200 bg-white pl-10 pr-10 py-2.5 text-sm text-slate-800 placeholder-slate-400 shadow-xs transition focus:outline-hidden focus:ring-2 focus:ring-sky-400/30 focus:border-sky-400"
                        />
                        {hasSearch && (
                            <button
                                onClick={() => setSearch("")}
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    {filteredApis.map((api) => {
                        ...
                        return (
                            <div
                                key={api}
                                className={`relative rounded-xl border border-slate-200 bg-white shadow-xs overflow-hidden transition-all duration-200 ${ringClass}`}
                            >
                                {/* Left accent bar */}
                                <div
