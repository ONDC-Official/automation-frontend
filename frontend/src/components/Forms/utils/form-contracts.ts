...
export const FORM_CONTRACTS: Record<string, IExpectedField[]> = {
    ...
    "FIS13/health/Proposer_Details_form": [
        ...
        { name: "politicallyExposedPerson", kind: "select", required: true },
        { name: "email", kind: "textlike", inputType: "email", required: true },
        { name: "phone", kind: "textlike", inputType: "tel", required: true },
        { name: "gstin", kind: "textlike" },
        { name: "weight", kind: "textlike", inputType: "number", required: true },
        { name: "height", kind: "textlike", inputType: "number", required: true },
    ...
    "FIS13/health/family_information_form": [
        ...
        { name: "panIndia", kind: "select", required: true },
    ...
    "FIS13/motor/vehicle_details_form": [
        ...
        { name: "lastName", kind: "textlike", required: true },
        { name: "email", kind: "textlike", inputType: "email" },
        { name: "phone", kind: "textlike", inputType: "tel" },
        { name: "gender", kind: "select", required: true },
        ...
        { name: "idv", kind: "textlike", inputType: "number" },
        { name: "coverType", kind: "select" },
        { name: "PersonalAccidentCover", kind: "select" },
        { name: "registrationNumber", kind: "textlike" },
        { name: "paTenure", kind: "textlike", inputType: "number" },
        { name: "policyTenure", kind: "textlike", inputType: "number" },
        { name: "previousPolicyInsurerName", kind: "textlike" },
        { name: "previousPolicyType", kind: "select" },
        ...
        { name: "ncb", kind: "textlike", inputType: "number" },
    ],
