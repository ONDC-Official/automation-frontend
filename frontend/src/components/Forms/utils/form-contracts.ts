...
export const FORM_CONTRACTS: Record<string, IExpectedField[]> = {
    ...
    // Mirrors the investor_details_form HTML for FIS14 Mutual Funds, in document order.
    "FIS14/investor_details_form": [
        { name: "name", kind: "textlike" },
        { name: "dob", kind: "textlike" },
        { name: "gender", kind: "select" },
        { name: "marital_status", kind: "select" },
        { name: "occupation", kind: "select" },
        { name: "source_of_wealth", kind: "select" },
        { name: "income_range", kind: "select" },
        { name: "cob", kind: "select" },
        { name: "pob", kind: "textlike" },
        { name: "political_exposure", kind: "select" },
        { name: "india_tax_residency_status", kind: "select" },
        { name: "mode_of_holding", kind: "select" },
        { name: "ca_line", kind: "textlike" },
        { name: "ca_pincode", kind: "textlike" },
        { name: "ca_country", kind: "select" },
        { name: "ca_nature", kind: "select" },
        { name: "oca_line", kind: "textlike" },
        { name: "oca_pincode", kind: "textlike" },
        { name: "oca_country", kind: "select" },
        { name: "oca_nature", kind: "select" },
        { name: "cp_number", kind: "textlike" },
        { name: "cp_belongsto", kind: "select" },
        { name: "ce_address", kind: "textlike" },
        { name: "ce_belongsto", kind: "select" },
        { name: "pba_number", kind: "textlike" },
        { name: "pba_pname", kind: "textlike" },
        { name: "pba_code", kind: "textlike" },
        { name: "pba_type", kind: "select" },
        { name: "trc_idtype", kind: "textlike" },
        { name: "trc_idnumber", kind: "textlike" },
        { name: "trc_country", kind: "select" },
        { name: "nominee_name", kind: "textlike" },
        { name: "nominee_idtype", kind: "select" },
        { name: "nominee_idnumber", kind: "textlike" },
        { name: "nominee_relationship", kind: "select" },
        { name: "nominee_cphone", kind: "textlike" },
        { name: "nominee_cemail", kind: "textlike" },
        { name: "nominee_caline", kind: "textlike" },
        { name: "nominee_cacountry", kind: "select" },
        { name: "nominee_capincode", kind: "textlike" },
        { name: "nominee_dob", kind: "textlike" },
        { name: "nominee_guardian_name", kind: "textlike" },
        { name: "nominee_gidtype", kind: "select" },
        { name: "nominee_gidnumber", kind: "textlike" },
        { name: "nominee_gcphone", kind: "textlike" },
        { name: "nominee_gcemail", kind: "textlike" },
        { name: "nominee_gcaline", kind: "textlike" },
        { name: "nominee_gcacountry", kind: "select" },
        { name: "nominee_gcapincode", kind: "textlike" },
        { name: "nominee_percentage", kind: "textlike" },
        { name: "nomination_display_setting", kind: "select" },
    ],

    "FIS12/personal_details_information_form": [
        { name: "fullName", kind: "textlike", required: true },
        { name: "personalEmail", kind: "textlike", inputType: "email" },
        { name: "officialEmail", kind: "textlike", inputType: "email" },
        { name: "dob", kind: "textlike", inputType: "date", required: true },
        { name: "gender", kind: "select", required: true },
        { name: "pan", kind: "textlike", required: true },
        { name: "contactNumber", kind: "textlike", inputType: "tel", required: true },
        { name: "employmentType", kind: "select", required: true },
        { name: "income", kind: "textlike", inputType: "number", required: true },
        { name: "companyName", kind: "textlike", required: true },
        { name: "udyamNumber", kind: "textlike" },
        { name: "addressL1", kind: "textlike" },
        { name: "addressL2", kind: "textlike" },
        { name: "city", kind: "textlike" },
        { name: "state", kind: "textlike" },
        { name: "pincode", kind: "textlike" },
        { name: "aa_id", kind: "textlike" },
        { name: "downpayment", kind: "textlike", inputType: "number" },
        { name: "bureauConsent", kind: "checkbox-single", required: true },
    ],

    // Mirrors the personal_loan_information_form HTML for FIS12 Personal Loan, in document order.
    "FIS12/personal_loan_information_form": [
        { name: "panName", kind: "textlike", required: true },
        { name: "personalemail", kind: "textlike", inputType: "email" },
        { name: "officialemail", kind: "textlike", inputType: "email" },
        { name: "dob", kind: "textlike", inputType: "date", required: true },
        { name: "gender", kind: "select", required: true },
        ...
        { name: "state", kind: "textlike" },
        { name: "pincode", kind: "textlike" },
        { name: "endUse", kind: "select", required: true },
        { name: "derivedData", kind: "file" },
        { name: "bureauConsent", kind: "checkbox-single", required: true },
    ],

    // Mirrors the down_payment_form HTML for FIS12 Personal Loan / Down Payment Update, in document order.
    "FIS12/down_payment_form": [
        { name: "updateDownpayment", kind: "textlike", inputType: "number", required: true },
    ],

    // Mirrors the product_details_form HTML for FIS12 Purchase Finance / Product Details, in document order.
    "FIS12/product_details_form": [
        { name: "pan", kind: "textlike" },
        { name: "gst", kind: "textlike" },
        { name: "bankAccountNumber", kind: "textlike" },
        { name: "bankIfscNumber", kind: "textlike" },
        { name: "bankAccountHolderName", kind: "textlike" },
        { name: "productCategory", kind: "textlike" },
        { name: "productBrand", kind: "textlike" },
        { name: "productModel", kind: "textlike" },
        { name: "productSKUID", kind: "textlike" },
        { name: "productPrice", kind: "textlike", inputType: "number" },
        { name: "productReturnPeriod", kind: "textlike" },
        { name: "maxSellerSubvention", kind: "textlike", inputType: "number" },
    ],
};
