...
export const FORM_CONTRACTS: Record<string, IExpectedField[]> = {
    ...
    "FIS14/investor_details_form": [
        ...
        { name: "dob", kind: "textlike", inputType: "date", required: true },
        { name: "gender", kind: "select", required: true },
        { name: "marital_status", kind: "select", required: true },
        { name: "occupation", kind: "select", required: true },
        { name: "source_of_wealth", kind: "select", required: true },
        { name: "income_range", kind: "select", required: true },
        { name: "cob", kind: "select", required: true },
        { name: "pob", kind: "textlike", required: true },
        { name: "political_exposure", kind: "select", required: true },
        { name: "india_tax_residency_status", kind: "select", required: true },
        ...
        { name: "cp_number", kind: "textlike", inputType: "tel" },
        { name: "cp_belongsto", kind: "select" },
        { name: "ce_address", kind: "textlike", inputType: "email" },
    ...
    "FIS12/personal_loan_information_form": [
        ...
        { name: "derivedData", kind: "textlike" },
        { name: "bureauConsent", kind: "checkbox-single", required: true },
    ],
