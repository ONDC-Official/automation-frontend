...
export const FORM_CONTRACTS: Record<string, IExpectedField[]> = {
    ...
    "FIS13/health/family_information_form": [
        ...
        { name: "height", kind: "textlike" },
        { name: "weight", kind: "textlike" },
        { name: "amount", kind: "textlike", inputType: "number" },
        { name: "planType", kind: "select" },
        { name: "panIndia", kind: "checkbox-single" },
