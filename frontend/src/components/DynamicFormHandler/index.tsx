...
import { IDynamicFormHandlerProps } from "@components/DynamicFormHandler/types";
...
export default function DynamicFormHandler({
  ...
  }, [actualSessionId, formSubmissionKey, submitEvent, cleanup, setSessionData]);
      ...
      {status === "idle" && (
        <div>
          <p className="text-gray-600 mb-4">
            Click the button below to open and complete the required form. A new tab will open where
