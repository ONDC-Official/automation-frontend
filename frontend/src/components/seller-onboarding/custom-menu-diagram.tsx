        ...
        <div className="bg-orange-50 border-2 border-orange-300 rounded-lg p-4">
          ...
          <div className="space-y-4">
            ...
            <div className="ml-8 space-y-2">
              <div className="text-sm font-medium text-gray-700 mb-1">Customization Items:</div>
              
              <Card size="small" className="border-purple-200 bg-purple-50">
                <div className="flex items-center justify-between">
                  <span className="text-sm">Small</span>
                  <div>
                    <Tag color="cyan" className="text-xs">customization</Tag>
        ...
        <Card className="mt-6 bg-gradient-to-r from-blue-50 to-purple-50">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-start">
              ...
              <span>Custom groups are <strong>separate entries</strong> in the categories array, not tags on items</span>
            </li>
            <li className="flex items-start">
              <span className="font-medium mr-2">2.</span>
              <span>Items <strong>reference</strong> custom groups by ID, they don't define them</span>
            </li>
            <li className="flex items-start">
              <span className="font-medium mr-2">3.</span>
              <span>Customization items have <strong>parent tags</strong> pointing to custom_group IDs</span>
            </li>
            <li className="flex items-start">
              <span className="font-medium mr-2">4.</span>
              <span>Child tags create <strong>sequential flows</strong> between custom groups</span>
            </li>
          </ul>
        </Card>
      </div>
