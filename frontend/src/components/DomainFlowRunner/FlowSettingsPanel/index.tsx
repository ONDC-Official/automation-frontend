...
const FlowSettingsPanel: React.FC<IFlowSettingsPanelProps> = ({
    ...
    const isGatewayAvailable = isGatewayToggleAvailable(domain, version);
    const skipItems = isGatewayAvailable
        ? SKIP_DIFFICULTY_ITEMS
        : [...SKIP_DIFFICULTY_ITEMS, "useGateway"];
