          ...
          <div className="p-4 border rounded-lg bg-gray-50 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={e => setNewKey({ ...newKey, signing_pub: e.target.value })}
              />
            </div>
            <div>
              ...
              <textarea
                ...
                onChange={e => setNewKey({ ...newKey, encryption_pub: e.target.value })}
              />
            </div>
            ...
            <div className="flex justify-end space-x-3">
              <button onClick={() => setIsAdding(false)} className="text-sm font-medium text-gray-600">
                Cancel
              </button>
              <GuideOverlay
          ...
          <div
            ...
            <details className="w-full group transition-all duration-200">
              <summary className="cursor-pointer flex items-center justify-between px-2 py-2 rounded hover:bg-gray-50 transition-colors duration-150">
                <span className="font-mono text-sm text-gray-800">UkId: {key.uk_id}</span>
                <div className="flex items-center space-x-2">
                  ...
                  <button onClick={() => onDeleteKey(key.uk_id)} className="text-gray-400 hover:text-red-600">
                    <TrashIcon />
                  </button>
                </div>
              </summary>
              <div className="pl-2 pr-2 pb-2 pt-1 animate-fade-in">
                <span className="block text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">Public Signing Key</span>
                <textarea
