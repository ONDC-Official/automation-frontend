// src/components/EditableListSection.tsx
...
interface EditableListSectionProps<T> {
	...
	description: string;
	items: T[];
	newItem: T; // A blank template for a new item
...
export function EditableListSection<T extends object>({
	...
	const handleAddNew = () => {
		onAddItem(newItem);
		// Open the new item for editing immediately
	...
	return (
		<div className="bg-white shadow-sm rounded-xl p-6 sm:p-8">
			...
			<div className="mt-6 flex gap-2">
				...
				{/* {id === "signing-keys" && <DownloadKeysButton />} */}
			</div>
						...
						{editingIndex === index ? (
							...
							<div className="bg-gray-50 border rounded-lg p-4">
								<div className="space-y-4">
									{renderEditForm(currentItem!, handleFieldChange)}
								</div>
