  ...
  return (
    <div>
      {isPayloadEditorActive && (
        <PayloadEditor
          onAdd={(payload: unknown) => handlePaste(payload as Record<string, unknown>)}
        />
      )}
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <p className="text-red-500 text-sm font-semibold">
          Please paste the on_search payload first to select the provider ID and provider name
        </p>
      </div>
        ...
        <div className={sectionStyle}>
          ...
          <div className={fieldWrapperStyle}>
            ...
            {availableProviders.length > 0 ? (
              <select {...register("providerId", { required: true })} className={inputStyle}>
          ...
          <div className={fieldWrapperStyle}>
            ...
            {availableProviders.length > 0 ? (
              <select {...register("providerName", { required: true })} className={inputStyle}>
