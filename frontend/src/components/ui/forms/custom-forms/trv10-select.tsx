                ...
                return (
                  <div className={fieldWrapperStyle}>
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                      {selectedItems[index]?.addOns?.map((selectedAddOn: any) => {
                        const addOnInfo = selectedExtracted.addOns.find(a => a.id === selectedAddOn.id);
                        ...
                        return (
                          <div
                            ...
                            <span className="font-medium text-sm text-blue-800 flex-1">{selectedAddOn.id}</span>
                            <div className="flex items-center gap-2">
                              ...
                              <input
                                ...
                                onChange={e => {
                                  ...
                                  const updated = currentAddOns.map((a: any) =>
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                setValue(
                                  `items.${index}.addOns`,
                                  currentAddOns.filter((a: any) => a.id !== selectedAddOn.id),
                                );
                              }}
