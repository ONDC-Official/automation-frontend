...
export default function FinvuRedirectForm({
  ...
  const checkCompletion = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/finvu/check-completion`, {
        params: {
      ...
      {status === "idle" && (
        <div>
          <p className="text-gray-600 mb-4">
            Click the button below to verify your account with Finvu Account Aggregator. A new tab will open where you
