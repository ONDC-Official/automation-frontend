...
signature="{base64_signature}"`}
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <div className="mb-8">
          <h4 className="text-lg font-semibold text-gray-800 mb-3">📦 Payload Format Scenarios</h4>
        ...
        {/* Timestamp Scenarios */}
        <div className="mb-8">
          <h4 className="text-lg font-semibold text-gray-800 mb-3">⏰ Timestamp Scenarios</h4>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-gray-100">
        ...
        <div className="mb-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-gray-300 px-4 py-2 text-left">Modification Type</th>
