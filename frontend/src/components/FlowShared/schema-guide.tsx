                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <p className="text-gray-700 font-medium mb-2">
                                Workbench is Currently available for the following domains (others
                                coming soon):
                            </p>
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <p className="text-gray-700 mb-3">
                                Paste/Upload Your API Payload. For Example: For search payload
                                validation, paste the JSON:
                            </p>
              ...
              "value": "yes"
                ...
                <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <p className="text-gray-700">
                                The tool takes the domain and the version for testing compliance.
                                Please ensure domain and version are as per{" "}
                ...
                <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <p className="text-gray-700">
                                Click <span className="font-semibold">"Validate"</span> to check for
                                errors in API schema, data types, required fields and enums
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <p className="text-gray-700 mb-3">
                                If there are any errors in the payload, it would display errors
                                like:
                            </p>
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <p className="text-gray-700">
                                ...
                                <span className="font-semibold text-sky-700">#5</span> and redo from
                                step <span className="font-semibold text-sky-700">#2</span>
                            </p>
                        </div>
                    </div>
                </div>
