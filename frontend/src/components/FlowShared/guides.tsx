  ...
  return (
    <div className="w-full bg-gray-50 border border-gray-200 p-6 overflow-y-auto">
      ...
      <p className="text-gray-600 mb-6 leading-relaxed">
        The Scenario Testing Tool is designed to facilitate end-to-end validation of ONDC (Open
        Network for Digital Commerce) workflows by simulating complete buyer-side and seller-side
        interactions. It enables testers, integrators, and network participants to execute
        comprehensive test scenarios that mirror real-world use cases across multiple domains such
        as retail, mobility, logistics, services, and more.
      </p>
      ...
      <div className="space-y-5 mb-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 pl-10">
            Select Domain for which you want to test. For example: If you want to test Retail F&B
            select <b>ONDC:RET11</b>
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 pl-10">
            Based on Domain it will display Version. Select the version for which you want to test.
            For Example: For Retail F&B <b>ONDC:RET11</b> it displays <b>1.2.5</b>
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 pl-10">
            Based on Domain and Version it displays a list of use cases. For Example: For Domain{" "}
            <b>ONDC:RET11</b> Version <b>1.2.5</b> it displays <b>F&B</b>
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 pl-10">
            If you are testing as Buyer NP then Select app Type as <b>BAP</b> and If you are testing
            as Seller NP then Select app Type as <b>BPP</b>
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <p className="text-gray-700 text-sm">
              <span className="font-semibold">#1</span> If you are Buyer NP then workbench would act
              as Seller NP and you would receive requests from URL
            </p>
          ...
          <div className="space-y-2">
            <p className="text-gray-700 text-sm">
              <span className="font-semibold">#2</span> If you are Seller NP then workbench would
              act as Buyer NP and you would receive requests from URL
            </p>
            <code className="block bg-white text-gray-800 px-3 py-2 rounded text-sm border border-blue-300">
