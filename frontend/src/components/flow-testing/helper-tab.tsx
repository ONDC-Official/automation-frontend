	...
	const guideItems = [
		{
			...
			content: (
				<p className="text-xs text-gray-600">
					Click the{" "}
					<span className="px-1 bg-sky-100 rounded text-sky-700 font-medium">
						Play
					</span>{" "}
		...
		},
		{
			...
			content: (
				<p className="text-xs text-gray-600">
					Disable validations using the <strong>Flow Settings</strong> button at
					the top.
				</p>
			),
		},
		...
		},
		{
			...
			content: (
				<p className="text-xs text-gray-600">
					After completion, <strong>manually stop the flow</strong> before
					starting a new one.
				</p>
			),
		},
